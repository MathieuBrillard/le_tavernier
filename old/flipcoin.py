...
async def Flipcoin(ctx):
    ...
    if alea % 2 == 0:
        ...
        coin = "Pile"
    ### Animation de lancer ###
    file = discord.File("ressources/coin-toss.gif", filename="coin-toss.gif")
    embed = discord.Embed(title='Lancement de la pièce ...',
    ...
    if coin == "Face":
        file = discord.File("ressources/face.jpg", filename="face.jpg")
        embed = discord.Embed(title="C'est **face** !",
                              color=discord.Color.gold())
        embed.set_image(url="attachment://face.jpg")
    else:
        file = discord.File("ressources/pile.jpg", filename="pile.jpg")
        embed = discord.Embed(title="C'est **pile** !",
                              color=discord.Color.gold())
