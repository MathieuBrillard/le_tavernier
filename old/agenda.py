        ...
        if i == 0:
            ...
            if len(event) == 5:
                ...
                to_send = "Auteur : "+auteur+"\nTitre : "+titre+"\nDate : " + \
                    date+"\nHeure : "+heure+"\nCommentaire : "+comment
            embed = discord.Embed(
                title=f'Evènement n°{i}', description=to_send, color=discord.Color.red())
        ...
        while continu:
            ...
            for ligne in lignes:
                ...
                if date == args[3] and time == args[4]:
                    ...
                    titre = '\N{BELL}'+" "+args[2]
                    embed = discord.Embed(
                        title=titre, description=to_send, color=discord.Color.red())
            ...
            if ok == True:
                ...
                if len(lignes) <= 1:
                    ...
                    print("Timer Stopped")
                    return
            # pour limiter la consommation de ressource inutilement
...
async def Agenda(ctx, args, bot):
    ...
    heure = args[2]
    if len(args) == 3:
        to_write = "\n"+str(channel_id)+";"+str(auteur) + \
            ";"+titre+";"+date+";"+heure
    elif len(args) == 4:
        comment = args[3]
        to_write = "\n"+str(channel_id)+";"+str(auteur) + \
            ";"+titre+";"+date+";"+heure+";"+comment
    f.write(to_write)
